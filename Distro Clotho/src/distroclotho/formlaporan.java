...
public class formlaporan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBackground(new java.awt.Color(208, 184, 218));
        ...
        jButton2.setBackground(new java.awt.Color(208, 184, 218));
        jButton2.setForeground(new java.awt.Color(0, 0, 0));
        jButton2.setText("LAPORAN STOK BARANG");
        ...
        jButton3.setBackground(new java.awt.Color(208, 184, 218));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
//        try{
//            Desktop.getDesktop().browse(new URL("http://localhost/penjualanelektronik/print.php").toURI());
//            } catch (Exception e){
//                System.out.println(e);
//            }
          laporanpenjualan fb = new   laporanpenjualan();
        fb.setVisible(true);
        this.setVisible(false);   
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
//        try{
//            Desktop.getDesktop().browse(new URL("http://localhost/penjualanelektronik/lapprint.php").toURI());
//            } catch (Exception e){
//                System.out.println(e);
//            }

        stokbarang fb = new   stokbarang();
        fb.setVisible(true);
        this.setVisible(false);   
